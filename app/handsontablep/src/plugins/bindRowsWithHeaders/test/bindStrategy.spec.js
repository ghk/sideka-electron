describe('BindRowsWithHeaders -> BindStrategy', function() {
  it('should registerStrategy under specified name', function() {
    var Klass = function() {};
    var strategy = new Handsontable.utils.BindStrategy();

    Handsontable.utils.BindStrategy.registerStrategy('test', Klass);
    strategy.setStrategy('test');

    expect(strategy.strategy instanceof Klass).toBe(true);
  });
