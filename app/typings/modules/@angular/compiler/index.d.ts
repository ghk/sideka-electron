...
export function applySourceSpanToStatementIfNeeded(stmt: Statement, sourceSpan: ParseSourceSpan): Statement;
export function applySourceSpanToExpressionIfNeeded(expr: Expression, sourceSpan: ParseSourceSpan): Expression;
export function variable(name: string, type?: Type, sourceSpan?: ParseSourceSpan): ReadVarExpr;
export function importExpr(id: CompileIdentifierMetadata, typeParams?: Type[], sourceSpan?: ParseSourceSpan): ExternalExpr;
export function importType(id: CompileIdentifierMetadata, typeParams?: Type[], typeModifiers?: TypeModifier[]): ExpressionType;
export function expressionType(expr: Expression, typeModifiers?: TypeModifier[]): ExpressionType;
export function literalArr(values: Expression[], type?: Type, sourceSpan?: ParseSourceSpan): LiteralArrayExpr;
...
export function fn(params: FnParam[], body: Statement[], type?: Type, sourceSpan?: ParseSourceSpan): FunctionExpr;
export function literal(value: any, type?: Type, sourceSpan?: ParseSourceSpan): LiteralExpr;
}
declare module '@angular/compiler/src/output/output_ast' {
