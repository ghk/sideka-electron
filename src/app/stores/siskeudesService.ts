...
const queryPdptAndPby = `SELECT Rek1.Akun, Rek1.Nama_Akun, Rek2.Kelompok, Rek2.Nama_Kelompok, Rek3.Jenis, Rek3.Nama_Jenis, Rek4.Obyek, Rek4.Nama_Obyek, Bdg.Kd_Bid, Bdg.Nama_Bidang, Keg.Kd_Keg, Keg.Nama_Kegiatan, RABSub.Kd_SubRinci, 
                                RABSub.Nama_SubRinci, RAB.Kd_Rincian, RABRi.Uraian, RABRi.SumberDana, RABRi.Satuan, RABRi.JmlSatuan, RAB.Kd_Desa, RABRi.HrgSatuan, RABRi.Anggaran, RABRi.JmlSatuanPAK, RABRi.HrgSatuanPAK, 
                                RABRi.AnggaranStlhPAK, RABRi.AnggaranPAK, RABRi.Kode_SBU, [Rek4.Obyek] & [RABSub.Kd_SubRinci] AS Kode_SubRinci, IIF(Rek3.Jenis = '5.1.3.', [Kode_SubRinci] & '.', Rek4.Obyek) & [RABRi.No_Urut] AS Kode_Rincian, 
                                Rek4.Obyek & [RABRi.No_Urut] AS Obyek_Rincian, RABRi.No_Urut
                        FROM     (((((Ta_RAB RAB LEFT OUTER JOIN
...
export default class SiskeudesService {
    ...
    async getRAB(year): Promise<any> {
        let queryPendapatan = queryPdptAndPby + ` WHERE ((Rek1.Akun = '4.') OR (Rek1.Akun = '6.')) AND (RAB.Kd_Desa = '${this.kodeDesa}') `
    ...
    getAllDesa(fileName, callback){
        ...
        let query = `SELECT Ta_Desa.Kd_Desa, Ta_Desa.Tahun, Ref_Desa.Nama_Desa FROM Ref_Kecamatan INNER JOIN (Ref_Desa INNER JOIN Ta_Desa ON Ref_Desa.Kd_Desa = Ta_Desa.Kd_Desa) ON Ref_Kecamatan.Kd_Kec = Ref_Desa.Kd_Kec; `
